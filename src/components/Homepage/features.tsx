  ...
  const features = [
    {
      ...
      title: "Live classes",
      description: "Host live sessions with students using HD video and screen sharing"
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Easily create and share course materials, documents, and resources"
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Assessments",
      description: "Build quizzes, exams, and assignments with automatic or manual grading"
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Monitor each student's progress and performance in real time"
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Communication",
      description: "Built-in messaging, discussion forums, and announcements to stay connected"
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Dashboards and reports to analyze engagement and results"
    }
  ];
