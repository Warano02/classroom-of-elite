...
export const metadata: Metadata = {
  title: "Sign up - IW",
  description:
    "Create your free account and start learning today. Join thousands of learners already growing their skills on E-Learn.",
};
      ...
      <div className="relative hidden lg:flex flex-1 flex-col justify-end p-14 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-6">
          <p className="max-w-md text-2xl font-light leading-relaxed text-white">
            Join a community of passionate learners and take your skills to the
            next level.
          </p>
